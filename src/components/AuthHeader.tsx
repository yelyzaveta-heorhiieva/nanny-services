...
export default function AuthHeader({ }: AuthHeaderProps) {
  ...
  return (
    <>
      <h3 className='font-medium text-[40px] leading-[120%] tracking-[-0.02em] text-[#11101c] mb-5'>
        {loginFormIsOpen ? 'Log In' : 'Registration'}
      </h3>
      <p className='font-normal text-base leading-[125%] text-[rgba(17,16,28,0.5)] mb-10'>
        {loginFormIsOpen
